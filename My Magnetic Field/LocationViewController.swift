...
//            mapView.showsUserLocation = true
            ...
            alert.addAction(UIAlertAction(title: "Done", style: .default){ doneAction in
                self.currentFilename = tField.text!
            })
...
//        saveLocation(of: location, and: mf)
        ...
        FileService.shared.recordLocations([currentLocation!], in: currentFilename)
